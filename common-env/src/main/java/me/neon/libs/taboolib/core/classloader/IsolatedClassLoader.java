package me.neon.libs.taboolib.core.classloader;
...
public class IsolatedClassLoader extends URLClassLoader {
    ...
    IsolatedClassLoader(URL[] urls, ClassLoader parent) {
        ...
        // JavaPlugin 直接访问
        excludedClasses.add("me.neon.libs.taboolib.core.classloader.IsolatedClassLoader");
        // 储存数据
        excludedClasses.add("me.neon.libs.taboolib.core.ClassAppender");
