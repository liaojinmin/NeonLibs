...
include("project:module-ui")
include("project:module-ui:ui-12100")
include("project:module-ui:ui-legacy")
include("project:module-configuration")
include("project:module-netease-form")

//include("project:module-effect")
include("common")
include("common-env")
include("common-script")
include("common-region")
include("common-test")
