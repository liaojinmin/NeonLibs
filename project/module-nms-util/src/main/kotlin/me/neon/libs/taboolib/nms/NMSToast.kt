...
import me.neon.libs.taboolib.nms.MinecraftVersion.V1_17
import me.neon.libs.taboolib.nms.MinecraftVersion.V1_18
import me.neon.libs.taboolib.nms.type.Toast
import me.neon.libs.taboolib.nms.type.ToastBackground
import me.neon.libs.taboolib.nms.type.ToastFrame
...
fun Player.sendToast(icon: Material, message: String, frame: ToastFrame = ToastFrame.TASK, background: ToastBackground = ToastBackground.ADVENTURE) {
    ...
    syncRunner {
        ...
        val namespaceKey = toastMap.getOrPut(cache) {
            injectAdvancement(NamespacedKey(NeonLibsLoader.getInstance(), "toast_${UUID.randomUUID()}"), jsonToast)
        }
        // 向玩家注册成就
