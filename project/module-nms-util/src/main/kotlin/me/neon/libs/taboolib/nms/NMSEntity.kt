...
fun <T : Entity> Location.spawnEntity(entity: Class<T>, prepare: Consumer<T> = Consumer { }): T {
    return nmsProxy<NMSEntity>(NeonLibsLoader.getInstance()).spawnEntity(this, entity, prepare)
}
...
fun Entity.getLocaleKey(): LocaleKey {
    return nmsProxy<NMSEntity>(NeonLibsLoader.getInstance()).getLocaleKey(this)
}
