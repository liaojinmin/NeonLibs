package me.neon.libs.taboolib.nms.type

import me.neon.libs.NeonLibsLoader
import me.neon.libs.taboolib.nms.NMSScoreboard
...
class PlayerScoreboard(val player: Player) {
    ...
    /** 记分板工具 */
    private val nmsScoreboard = nmsProxy<NMSScoreboard>(NeonLibsLoader.getInstance())
