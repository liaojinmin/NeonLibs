...
import me.neon.libs.taboolib.ui.Menu
...
interface Chest : Menu {
     ...
     * 根据抽象符号设置物品
     */
    fun set(slot: Char, material: Material, itemBuilder: ItemBuilder.() -> Unit = {})

    /**
     * 根据位置设置物品
     */
    fun set(slot: Int, material: Material, itemBuilder: ItemBuilder.() -> Unit = {})
