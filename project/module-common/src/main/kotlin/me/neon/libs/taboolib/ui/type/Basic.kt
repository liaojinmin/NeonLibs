...
import me.neon.libs.utils.item.ItemBuilder
import me.neon.libs.utils.item.buildItem
...
open class Basic(title: String = "chest") : Menu(title) {
     ...
     * 根据抽象符号设置物品
     */
    open fun set(slot: Char, material: Material, itemBuilder: ItemBuilder.() -> Unit = {}) {
     ...
     * 根据位置设置物品
     */
    open fun set(slot: Int, material: Material, itemBuilder: ItemBuilder.() -> Unit = {}) {
        set(slot, buildItem(material, itemBuilder))
    }
