...
import me.neon.libs.taboolib.cmd.component.CommandComponentDynamic
import me.neon.libs.taboolib.cmd.component.CommandComponentLiteral
import me.neon.libs.taboolib.lang.asLangText
import org.bukkit.plugin.Plugin


fun CommandComponent.createHelper(plugin: Plugin, checkPermissions: Boolean = true) {
            ...
            when (compound) {
                ...
                is CommandComponentDynamic -> {
                    val value = if (compound.comment.startsWith("@")) {
                        sender.asLangText(plugin, compound.comment.substring(1))
                    } else {
                        compound.comment
                    }
